...
<html>
  <head>
    ...
    <!-- Bootstrap CSS-->
      ...
      LoadBootStrapCSS();
      LoadFontAwesome();
      LoadCSS(ReplaceSlashes(dirname(__file__)), "css/", "custom.css");
      ?>
    <!-- Font Awesome CSS-->
  ...
  <body>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span><?php echo Config("SiteDetails", "SiteName"); ?> </span><strong class="text-primary"> Dashboard</strong></div></a></div>
    ...
    LoadJQuery();
    LoadBootStrapJS();
    LoadJS(ReplaceSlashes(dirname(__file__)), "vendor/popper.js/umd/", "popper.min.js");

    LoadJS(ReplaceSlashes(dirname(__file__)), "js/", "grasp_mobile_progress_circle-1.0.0.min.js");

    LoadJS(ReplaceSlashes(dirname(__file__)), "vendor/jquery.cookie/", "jquery.cookie.js");

    LoadJS(ReplaceSlashes(dirname(__file__)), "vendor/chart.js/", "Chart.min.js");

    LoadJS(ReplaceSlashes(dirname(__file__)), "vendor/jquery-validation/", "jquery.validate.min.js");


    LoadJS(ReplaceSlashes(dirname(__file__)), "vendor/malihu-custom-scrollbar-plugin/", "jquery.mCustomScrollbar.concat.min.js");


    LoadJS(ReplaceSlashes(dirname(__file__)), "js/", "charts-home.js");
    LoadJS(ReplaceSlashes(dirname(__file__)), "js/", "front.js");
