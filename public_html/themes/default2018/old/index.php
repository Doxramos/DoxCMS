...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <?php
    LoadCSS("vendor/bootstrap/css");

    LoadCSS("dist/css");
    LoadCSS("vendor/datatables/css");
    LoadCSS("vendor/datatables-plugins");
    LoadCSS("vendor/font-awesome/css");
    LoadCSS("vendor/metisMenu");
    LoadCSS("vendor/morrisjs");
    ?>
    <!-- MetisMenu CSS -->
...
<body>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="../parts/login.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../parts/login.php">Login Page</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
    ...
    <!-- jQuery -->
    <?php
    LoadJS("vendor/jquery");

    LoadJS("vendor/bootstrap/js");
    LoadJS("vendor/metisMenu");
    LoadJS("vendor/raphael");
    LoadJS("vendor/morrisjs");
    LoadJS("data");
    LoadJS("dist/js");
    ?>
